...
function Policy() {
  return (
    <>
      <div className="min-h-screen bg-gray-50 p-6 flex flex-col items-center dark:bg-gray-800">
        <Link
          to="/"
          className="mt-4 px-6 py-3 bg-gray-500 text-white rounded-xl shadow-md hover:bg-gray-600 transition dark:bg-gray-900"
        >
          Go to Back
        </Link>
        {/* Title */}
        ...
        <div className="max-w-4xl w-full space-y-6 ">
          {/* Privacy Policy */}
          <div className="bg-white shadow-md rounded-2xl p-6 dark:bg-gray-900 dark:bg-green-100">
          ...
          {/* Refund Policy */}
          <div className="bg-white shadow-md rounded-2xl p-6 dark:bg-gray-900 dark:bg-yellow-100">
            <h2 className="text-2xl font-semibold text-gray-700 mb-2">
          ...
          <div className="bg-white shadow-md rounded-2xl p-6 dark:bg-gray-900 dark:bg-pink-100">
            <h2 className="text-2xl font-semibold text-gray-700 mb-2">
              🚚 Delivery Policy
            </h2>
            <p className="text-gray-600">
        ...
        {/* Last Updated */}
        <p className="mt-12 text-gray-500 dark:text-blue-300">
